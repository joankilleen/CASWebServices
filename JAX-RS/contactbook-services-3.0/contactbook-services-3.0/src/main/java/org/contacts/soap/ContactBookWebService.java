...
public class ContactBookWebService implements ContactBook {
	...
	@Override
	public long createContact(String name, String phone, String email, String twitter) {
		return contactBook.create(name, phone, email, twitter);
	}
	...
	private ContactEntity convert(Contact contact) {
		return new ContactEntity(contact.getId(), contact.getName(), contact.getPhone(), contact.getEmail(), contact.getTwitter());
	}
}
